const MOBILE_DASHBOARD_CSS = `
    @media (max-width:760px){
      ...
      .drawer{position:fixed;inset:0;width:100vw;max-width:none;height:100dvh;max-height:100dvh;padding:0 14px calc(24px + env(safe-area-inset-bottom));border-left:0;overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;background:#0e1014;}
      ...
      .detailgrid{grid-template-columns:1fr;gap:10px;margin-top:0;}
      .detail{padding:14px;border-radius:14px;}
      ...
      .event{margin:0 0 10px;border:1px solid #242832;border-left:3px solid #3a404b;border-radius:12px;background:#111318;padding:12px 13px;}
