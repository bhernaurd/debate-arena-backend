const MOBILE_DASHBOARD_CSS = `
    @media (max-width:760px){
      ...
      .drawerback.open{display:block;overflow:hidden;overscroll-behavior:contain;}
      .drawer{display:block;position:fixed;inset:0;width:100vw;max-width:none;height:100dvh;max-height:100dvh;padding:0 14px calc(24px + env(safe-area-inset-bottom));border-left:0;border-right:0;border-bottom:0;overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;background:#0e1014;grid-template-columns:none;grid-template-areas:none;gap:0;align-items:initial;}
      .drawerhead{position:sticky;top:0;margin:0 -14px 14px;padding:calc(14px + env(safe-area-inset-top)) 14px 12px;background:#0e1014;border-bottom:1px solid var(--line);z-index:5;align-items:flex-start;box-shadow:0 8px 18px rgba(0,0,0,.18);}
      .drawerhead>div{min-width:0;flex:1;}
      .drawer h2{font-size:18px;line-height:1.25;overflow-wrap:anywhere;word-break:break-word;}
      .drawerhead .sub{font-size:11px;line-height:1.35;overflow-wrap:anywhere;word-break:break-all;margin-top:4px;}
      .close{flex:0 0 auto;align-self:flex-start;margin:0;padding:8px 12px;border-radius:10px;}
      .detailgrid{display:grid;grid-template-columns:1fr;gap:10px;margin-top:0;width:100%;}
      .detail{padding:14px;border-radius:14px;min-width:0;width:100%;}
      .detail b{font-size:10px;margin-bottom:7px;}
      .detail span{font-size:15px;line-height:1.45;overflow-wrap:anywhere;word-break:break-word;}
      .timeline{margin-top:24px;width:100%;}
      .timeline+.timeline{margin-top:30px;}
      .timeline h3{font-size:16px;margin:0 0 12px;line-height:1.25;}
      .event{display:block;width:100%;margin:0 0 10px;border:1px solid #242832;border-left:3px solid #3a404b;border-radius:12px;background:#111318;padding:12px 13px;}
      .event strong{display:block;font-size:13px;line-height:1.4;overflow-wrap:anywhere;word-break:break-word;}
      .event small{display:block;font-size:11px;line-height:1.45;margin-top:6px;overflow-wrap:anywhere;word-break:break-word;}
