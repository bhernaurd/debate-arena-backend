const MOBILE_DASHBOARD_CSS = `
    @media (max-width:760px){
      ...
      #breakdownChart,#accountsDailyChart{overflow-x:auto;-webkit-overflow-scrolling:touch;scrollbar-width:none;}
      #breakdownChart::-webkit-scrollbar,#accountsDailyChart::-webkit-scrollbar{display:none;}
