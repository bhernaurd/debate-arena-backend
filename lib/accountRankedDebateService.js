...
function normalizeDebate(
    ...
    if (
        ...
        fail(
            'ranked_debate_state_unavailable',
            'An active Ranked debate contains completion metadata.',
            {
                status: 503,
                retryable: true,
            }
            ...
            const result =
                await client.query(
                    `
                        ...
                        SET
                            placement_status = $3,
                            placement_trials_completed = $4,
                            placement_weighted_score = $5,
                            current_rank_key = $6,
                            current_division = $7,
                            current_rp = $8,
                            peak_rank_key = $6,
                            ...
                            demotion_protection_granted_at =
                                ...
                                END,
                            ranked_debates_completed =
                                ranked_debates_completed + 1,
                            last_ranked_debate_completed_at = $9,
                            state_version = state_version + 1,
                            updated_at = GREATEST(
                                updated_at,
                                $9
