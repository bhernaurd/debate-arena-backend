...
// eligible. These gates are evaluated on every Ranked start, so a long-running
// Railway process unlocks philosophers automatically without a restart.
const RANKED_RELEASE_GATES = Object.freeze({
    kierkegaard: Date.parse('2026-08-12T04:00:00Z'),
    schopenhauer: Date.parse('2026-09-19T10:00:00Z'),
});
