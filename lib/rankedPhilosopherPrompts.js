...
} from './expandedPhilosopherPrompts.js';

const SCHOPENHAUER_STANDARD_PROMPT =
    findExpandedPhilosopherPrompt('schopenhauer');

if (!SCHOPENHAUER_STANDARD_PROMPT) {
    throw new Error(
        'The canonical Schopenhauer Expanded Agora prompt is unavailable.'
    );
}
...
Do not use visible asterisks for emphasis. Your premium force should come from sharper existential distinctions, more exact use of paradox and inwardness, and a more personal demand that the user connect a stated belief to an actual choice.`,
    ...
    "schopenhauer": Object.freeze({
        ...
        systemPrompt:
            SCHOPENHAUER_STANDARD_PROMPT.systemPrompt,
        proEmphasisAddendum: `PRO EMPHASIS STYLE:
Do not use visible asterisks for emphasis. Your premium force should come from colder precision about desire, motive, suffering, compassion, and the distinction between the world as representation and the will beneath it.`,
    }),
});
