...
- summary.overview should be a concise "philosophy at a glance" synthesis of the user's apparent outlook across the dimensions. Keep it to 2 sentences and roughly 55 words or fewer.
- reflection should be the deeper synthesis: 3-5 sentences, roughly 120 words or fewer, explaining how the supplied coordinates fit together, where the worldview has internal tension, and what makes the profile philosophically distinctive. Do not merely repeat summary.overview.
- summary.headline must be 4-8 words of plain English that describe the user's apparent worldview. Do not use metaphors, literary chapter-title language, phrases such as "at the threshold", "between worlds", or "at the crossroads", and do not use an archetype name in the headline.
...
OUTPUT SCHEMA:
{
  ...
  "summary": {"headline": "4-8 word plain-English sentence-case description of the user's worldview; no metaphor and no archetype name", "overview": "2 concise sentences, about 55 words or fewer, summarizing what the profile suggests about the user's philosophy"},
