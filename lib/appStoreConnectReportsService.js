...
export function createAppStoreConnectReportsService({
  ...
  function assertConfigured() {
    if (!isConfigured()) {
      throw statusError(
        503,
        'Apple proceeds reporting is not configured. Add APP_STORE_CONNECT_ISSUER_ID, APP_STORE_CONNECT_KEY_ID, APP_STORE_CONNECT_PRIVATE_KEY, and APP_STORE_CONNECT_VENDOR_NUMBER.',
