export function enhanceSubscriptionAdminRevenueHtml(html) {
  ...
  output = output
    ...
    .replace(
      ...
      `      <div class="section">\n        <div class="sectionhead"><h2>Revenue trend</h2><span id="revenueTrendSummary">Gross sales vs Apple proceeds · USD</span></div>\n        <div id="revenueTrendChart" class="revenue-trend-chart"><div class="loading">Loading revenue trend...</div></div>\n      </div>\n      <div class="section">\n        <div class="sectionhead"><h2>Monthly financial history</h2><span>Production · America/Chicago</span></div>`
    )
    .replace(
  ...
  output = output
    ...
    .replace(
      ...
      `    const metrics=qs('#historyMetrics'), chart=qs('#revenueTrendChart'), table=qs('#historyTable'), finance=qs('#financialHistoryTable');\n    metrics.innerHTML='<div class="loading">Loading revenue...</div>'; chart.innerHTML='<div class="loading">Loading revenue trend...</div>'; table.innerHTML='<div class="loading">Loading monthly financial history...</div>'; finance.innerHTML='<div class="loading">Loading financial reports...</div>';`
    )
    .replace(
