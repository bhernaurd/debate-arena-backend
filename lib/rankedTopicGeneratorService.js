...
function requireCanonicalPhilosopherID(value, now = new Date()) {
    const philosopherID =
        cleanString(
            value,
            'philosopherId',
...
- For Camus, Dostoevsky, Kierkegaard, or Schopenhauer, never romanticize suicide, self-harm, death, despair, anxiety, or suffering.
