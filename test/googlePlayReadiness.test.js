...
test('Google Play readiness check covers the production Android billing prerequisites', () => {
...
test('Google Play readiness output reports only state, never secret values', () => {
